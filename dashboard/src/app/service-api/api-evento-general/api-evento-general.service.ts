...
export class ApiEventoGeneralService {
  ...
  //Metodos de la clase 
  obtenerEventos(){
    return this.http.get(`https://us-central1-backend-evolet.cloudfunctions.net/api/eventos/obtenerEventosGeneral`); 
  }
  ...
  crearEvento(evento){
    return this.http.post(`https://us-central1-backend-evolet.cloudfunctions.net/api/eventos/registrarEventoGeneral`,evento); 
  }
